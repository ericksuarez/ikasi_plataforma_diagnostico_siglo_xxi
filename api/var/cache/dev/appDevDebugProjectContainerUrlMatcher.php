...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/teacher')) {
            ...
            // teacher_delete
            if (0 === strpos($pathinfo, '/teacher/delete') && preg_match('#^/teacher/delete(?:/(?P<id>[^/]++))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_teacher_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'teacher_delete')), array (  '_controller' => 'AppBundle\\Controller\\TeacherController::deleteAction',  'id' => NULL,));
            }
            not_teacher_delete:
