 ...
 */
class AnswerInee extends \BackendBundle\Entity\AnswerInee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\AnswerInee' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\AnswerInee' . "\0" . 'title', '' . "\0" . 'BackendBundle\\Entity\\AnswerInee' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\AnswerInee' . "\0" . 'updateTime', '' . "\0" . 'BackendBundle\\Entity\\AnswerInee' . "\0" . 'evaluationInee'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AnswerInee $proxy) {
