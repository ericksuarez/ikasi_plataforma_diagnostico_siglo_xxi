 ...
 */
class Category extends \BackendBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\Category' . "\0" . 'status', '' . "\0" . 'BackendBundle\\Entity\\Category' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\Category' . "\0" . 'updateTime'];
        }
