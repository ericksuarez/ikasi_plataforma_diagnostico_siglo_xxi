 ...
 */
class Indicator extends \BackendBundle\Entity\Indicator implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Indicator' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Indicator' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\Indicator' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\Indicator' . "\0" . 'updateTime', '' . "\0" . 'BackendBundle\\Entity\\Indicator' . "\0" . 'parameter'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Indicator $proxy) {
