 ...
 */
class Dimension extends \BackendBundle\Entity\Dimension implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Dimension' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Dimension' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\Dimension' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\Dimension' . "\0" . 'updateTime', '' . "\0" . 'BackendBundle\\Entity\\Dimension' . "\0" . 'educationLevel', '' . "\0" . 'BackendBundle\\Entity\\Dimension' . "\0" . 'teacherFunction', '' . "\0" . 'BackendBundle\\Entity\\Dimension' . "\0" . 'speciality'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Dimension $proxy) {
