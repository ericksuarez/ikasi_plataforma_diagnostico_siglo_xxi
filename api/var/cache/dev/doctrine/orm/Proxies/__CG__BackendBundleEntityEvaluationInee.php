 ...
 */
class EvaluationInee extends \BackendBundle\Entity\EvaluationInee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'educationLevel', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'teacherFunction', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'reagentBase', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'argumentation', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'reference', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'updateTime', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'dimension', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'parameter', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'indicator', '' . "\0" . 'BackendBundle\\Entity\\EvaluationInee' . "\0" . 'correctAnswer'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EvaluationInee $proxy) {
    ...
    public function setReagentBase($reagentBase)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setReagentBase', [$reagentBase]);

        return parent::setReagentBase($reagentBase);
    }
    ...
    public function getReagentBase()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReagentBase', []);

        return parent::getReagentBase();
    }
    ...
    public function setArgumentation($argumentation)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setArgumentation', [$argumentation]);

        return parent::setArgumentation($argumentation);
    }
    ...
    public function getArgumentation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getArgumentation', []);

        return parent::getArgumentation();
    }
    ...
    public function setParameter(\BackendBundle\Entity\Parameter $parameter = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setParameter', [$parameter]);
    ...
    public function setIndicator(\BackendBundle\Entity\Indicator $indicator = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIndicator', [$indicator]);

        return parent::setIndicator($indicator);
    }
    ...
    public function getIndicator()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIndicator', []);
    ...
    public function setCorrectAnswer(\BackendBundle\Entity\AnswerInee $correctAnswer = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCorrectAnswer', [$correctAnswer]);

        return parent::setCorrectAnswer($correctAnswer);
    }
