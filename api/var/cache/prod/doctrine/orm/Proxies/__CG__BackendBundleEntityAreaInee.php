 ...
 */
class AreaInee extends \BackendBundle\Entity\AreaInee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'skillIneeId', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'minVulnerable', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'maxVulnerable', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'minCompetent', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'maxCompetent', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'minOtimum', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'maxOtimum', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'status', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\AreaInee' . "\0" . 'updateTime'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AreaInee $proxy) {
    ...
    public function setSkillIneeId($skillIneeId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSkillIneeId', [$skillIneeId]);

        return parent::setSkillIneeId($skillIneeId);
    }
    ...
    public function getSkillIneeId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSkillIneeId', []);

        return parent::getSkillIneeId();
    }
