 ...
 */
class EvaluationCentury extends \BackendBundle\Entity\EvaluationCentury implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\EvaluationCentury' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\EvaluationCentury' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\EvaluationCentury' . "\0" . 'updateTime', '' . "\0" . 'BackendBundle\\Entity\\EvaluationCentury' . "\0" . 'evaluation', '' . "\0" . 'BackendBundle\\Entity\\EvaluationCentury' . "\0" . 'skillCentury'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EvaluationCentury $proxy) {
