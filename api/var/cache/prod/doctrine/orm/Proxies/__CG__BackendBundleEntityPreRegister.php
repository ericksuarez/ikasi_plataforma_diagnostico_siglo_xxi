 ...
 */
class PreRegister extends \BackendBundle\Entity\PreRegister implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\PreRegister' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\PreRegister' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\PreRegister' . "\0" . 'curp', '' . "\0" . 'BackendBundle\\Entity\\PreRegister' . "\0" . 'teacherFunction', '' . "\0" . 'BackendBundle\\Entity\\PreRegister' . "\0" . 'educationLevel', '' . "\0" . 'BackendBundle\\Entity\\PreRegister' . "\0" . 'speciality', '' . "\0" . 'BackendBundle\\Entity\\PreRegister' . "\0" . 'email'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PreRegister $proxy) {
