...
class TeacherFunction extends \BackendBundle\Entity\TeacherFunction implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\TeacherFunction' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\TeacherFunction' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\TeacherFunction' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\TeacherFunction' . "\0" . 'updateTime'];
        }
