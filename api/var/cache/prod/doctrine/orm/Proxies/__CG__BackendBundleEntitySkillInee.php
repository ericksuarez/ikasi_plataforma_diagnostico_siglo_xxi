 ...
 */
class SkillInee extends \BackendBundle\Entity\SkillInee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\SkillInee' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\SkillInee' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\SkillInee' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\SkillInee' . "\0" . 'updateTime'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SkillInee $proxy) {
