 ...
 */
class CourseCentury extends \BackendBundle\Entity\CourseCentury implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\CourseCentury' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\CourseCentury' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\CourseCentury' . "\0" . 'updateTime', '' . "\0" . 'BackendBundle\\Entity\\CourseCentury' . "\0" . 'skillCentury', '' . "\0" . 'BackendBundle\\Entity\\CourseCentury' . "\0" . 'course'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CourseCentury $proxy) {
