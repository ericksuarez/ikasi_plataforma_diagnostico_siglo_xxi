 ...
 */
class Answer extends \BackendBundle\Entity\Answer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Answer' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Answer' . "\0" . 'description', '' . "\0" . 'BackendBundle\\Entity\\Answer' . "\0" . 'correctAnswer', '' . "\0" . 'BackendBundle\\Entity\\Answer' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\Answer' . "\0" . 'updateTime', '' . "\0" . 'BackendBundle\\Entity\\Answer' . "\0" . 'question'];
        }
