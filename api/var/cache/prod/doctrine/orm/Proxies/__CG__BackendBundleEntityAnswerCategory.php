 ...
 */
class AnswerCategory extends \BackendBundle\Entity\AnswerCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\AnswerCategory' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\AnswerCategory' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\AnswerCategory' . "\0" . 'value', '' . "\0" . 'BackendBundle\\Entity\\AnswerCategory' . "\0" . 'status', '' . "\0" . 'BackendBundle\\Entity\\AnswerCategory' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\AnswerCategory' . "\0" . 'updateTime', '' . "\0" . 'BackendBundle\\Entity\\AnswerCategory' . "\0" . 'category'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AnswerCategory $proxy) {
