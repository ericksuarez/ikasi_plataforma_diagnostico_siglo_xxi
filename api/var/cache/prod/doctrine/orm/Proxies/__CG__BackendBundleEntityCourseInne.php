 ...
 */
class CourseInne extends \BackendBundle\Entity\CourseInne implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\CourseInne' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\CourseInne' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\CourseInne' . "\0" . 'updateTime', '' . "\0" . 'BackendBundle\\Entity\\CourseInne' . "\0" . 'course', '' . "\0" . 'BackendBundle\\Entity\\CourseInne' . "\0" . 'skillInne'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CourseInne $proxy) {
