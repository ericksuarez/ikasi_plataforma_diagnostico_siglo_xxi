 ...
 */
class EvaluationTeacher extends \BackendBundle\Entity\EvaluationTeacher implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\EvaluationTeacher' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\EvaluationTeacher' . "\0" . 'score', '' . "\0" . 'BackendBundle\\Entity\\EvaluationTeacher' . "\0" . 'status', '' . "\0" . 'BackendBundle\\Entity\\EvaluationTeacher' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\EvaluationTeacher' . "\0" . 'updateTime', '' . "\0" . 'BackendBundle\\Entity\\EvaluationTeacher' . "\0" . 'teacher', '' . "\0" . 'BackendBundle\\Entity\\EvaluationTeacher' . "\0" . 'evaluation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EvaluationTeacher $proxy) {
