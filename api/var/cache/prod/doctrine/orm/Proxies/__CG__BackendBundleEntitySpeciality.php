...
class Speciality extends \BackendBundle\Entity\Speciality implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Speciality' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Speciality' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\Speciality' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\Speciality' . "\0" . 'updateTime'];
        }
