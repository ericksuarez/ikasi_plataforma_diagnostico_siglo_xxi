 ...
 */
class Question extends \BackendBundle\Entity\Question implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Question' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Question' . "\0" . 'description', '' . "\0" . 'BackendBundle\\Entity\\Question' . "\0" . 'typeQuestion', '' . "\0" . 'BackendBundle\\Entity\\Question' . "\0" . 'correctAnswer', '' . "\0" . 'BackendBundle\\Entity\\Question' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\Question' . "\0" . 'updateTime', '' . "\0" . 'BackendBundle\\Entity\\Question' . "\0" . 'evaluation'];
        }
    ...
    public function setTypeQuestion($typeQuestion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeQuestion', [$typeQuestion]);
