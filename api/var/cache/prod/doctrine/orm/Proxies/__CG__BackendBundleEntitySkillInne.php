 ...
 */
class SkillInne extends \BackendBundle\Entity\SkillInne implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\SkillInne' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\SkillInne' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\SkillInne' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\SkillInne' . "\0" . 'updateTime'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SkillInne $proxy) {
