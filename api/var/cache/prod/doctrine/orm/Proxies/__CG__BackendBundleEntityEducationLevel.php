...
class EducationLevel extends \BackendBundle\Entity\EducationLevel implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\EducationLevel' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\EducationLevel' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\EducationLevel' . "\0" . 'createTime', '' . "\0" . 'BackendBundle\\Entity\\EducationLevel' . "\0" . 'updateTime'];
        }
