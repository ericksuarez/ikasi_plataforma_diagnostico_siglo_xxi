...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.access_control' => 'getApp_AccessControlService',
            'app.email' => 'getApp_EmailService',
            'app.encrypt' => 'getApp_EncryptService',
            'app.helpers' => 'getApp_HelpersService',
            'app.import_inee' => 'getApp_ImportIneeService',
            'app.import_teacher' => 'getApp_ImportTeacherService',
            'app.inee_results' => 'getApp_IneeResultsService',
            'app.jwt_auth' => 'getApp_JwtAuthService',
            'app.suggestions' => 'getApp_SuggestionsService',
    ...
    /*
     * Gets the 'app.access_control' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\AccessControl A AppBundle\Services\AccessControl instance
     */
    protected function getApp_AccessControlService()
    {
        return $this->services['app.access_control'] = new \AppBundle\Services\AccessControl($this->get('doctrine.orm.default_entity_manager'));
    }

    /*
     * Gets the 'app.email' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\Email A AppBundle\Services\Email instance
     */
    protected function getApp_EmailService()
    {
        return $this->services['app.email'] = new \AppBundle\Services\Email($this->get('templating'), $this->get('swiftmailer.mailer.default'));
    }

    /*
     * Gets the 'app.encrypt' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\Encrypt A AppBundle\Services\Encrypt instance
     */
    protected function getApp_EncryptService()
    {
        return $this->services['app.encrypt'] = new \AppBundle\Services\Encrypt();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\Helpers A AppBundle\Services\Helpers instance
     */
    protected function getApp_HelpersService()
    {
        return $this->services['app.helpers'] = new \AppBundle\Services\Helpers($this->get('app.jwt_auth'));
    }

    /*
     * Gets the 'app.import_inee' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\ImportInee A AppBundle\Services\ImportInee instance
     */
    protected function getApp_ImportIneeService()
    {
        return $this->services['app.import_inee'] = new \AppBundle\Services\ImportInee($this->get('doctrine.orm.default_entity_manager'));
    }

    /*
     * Gets the 'app.import_teacher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\ImportTeacher A AppBundle\Services\ImportTeacher instance
     */
    protected function getApp_ImportTeacherService()
    {
        return $this->services['app.import_teacher'] = new \AppBundle\Services\ImportTeacher($this->get('doctrine.orm.default_entity_manager'), $this->get('validator'));
    }

    /*
     * Gets the 'app.inee_results' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\IneeResults A AppBundle\Services\IneeResults instance
     */
    protected function getApp_IneeResultsService()
    {
        return $this->services['app.inee_results'] = new \AppBundle\Services\IneeResults($this->get('doctrine.orm.default_entity_manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\JwtAuth A AppBundle\Services\JwtAuth instance
     */
    protected function getApp_JwtAuthService()
    {
        return $this->services['app.jwt_auth'] = new \AppBundle\Services\JwtAuth($this->get('doctrine.orm.default_entity_manager'), $this->get('app.encrypt'), $this->get('app.access_control'));
    }

    /*
     * Gets the 'app.suggestions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\SuggestedCourses A AppBundle\Services\SuggestedCourses instance
     */
    protected function getApp_SuggestionsService()
    {
        return $this->services['app.suggestions'] = new \AppBundle\Services\SuggestedCourses($this->get('doctrine.orm.default_entity_manager'), $this->get('app.inee_results'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('VGHYmstEEq', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cgunOEgjmG', 0, 'AeiOU9pNmmWQL9vXyRWpLm', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Iie0xT5NZc', 0, 'AeiOU9pNmmWQL9vXyRWpLm', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    { 
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'dsxxi_sinadep_app_desa', 'user' => 'dsxxi', 'password' => 'vd#rW,Atj;EPOl37EHZpykf', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/BackendBundle/Resources/config/doctrine') => 'BackendBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'BackendBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('BackendBundle' => 'BackendBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_d70e13bafecb54565a5d12fe01ba57ced810f3cc0bf706ce73511d99e2163439');
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('contacto@diagnosticosxxi.org');
        $a->setPassword('F-tr!G2+7P+=');
        $a->setAuthMode(NULL);
        ...
        $instance->setHost('diagnosticosxxi.org');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('trA#A=$U*5cR7sw35U25?eMev&Ma@8Pr');
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KYHmifXugZ', 0, 'AeiOU9pNmmWQL9vXyRWpLm', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a93bca8d89c04.29495002')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'dsxxi_sinadep_app_desa',
            'database_user' => 'dsxxi',
            'database_password' => 'vd#rW,Atj;EPOl37EHZpykf',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'diagnosticosxxi.org',
            'mailer_user' => 'contacto@diagnosticosxxi.org',
            'mailer_password' => 'F-tr!G2+7P+=',
            'mailer_port' => 465,
            'mailer_encryption' => 'ssl',
            'secret' => 'trA#A=$U*5cR7sw35U25?eMev&Ma@8Pr',
            'serverroot' => 'https://test.diagnosticosxxi.org',
            'serverrootapi' => 'https://apitest.diagnosticosxxi.org/',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'trA#A=$U*5cR7sw35U25?eMev&Ma@8Pr',
            ...
            'validator.mapping.cache.prefix' => 'validator_4216ff691028c22146ec464a223d3087669fc56644ff26b30886cfc6c7297b8f',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'diagnosticosxxi.org',
            'swiftmailer.mailer.default.transport.smtp.username' => 'contacto@diagnosticosxxi.org',
            'swiftmailer.mailer.default.transport.smtp.password' => 'F-tr!G2+7P+=',
