...
var AdminSkillCenturyCategoryComponent = /** @class */ (function (_super) {
    __extends(AdminSkillCenturyCategoryComponent, _super);
    function AdminSkillCenturyCategoryComponent(_skillCenturyCategoryService, activatedRoute, _notificationsService) {
    ...
    AdminSkillCenturyCategoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        this.activatedRoute.params.subscribe(function (params) {
            ...
            _this._skillCenturyCategoryService.findAll(_this.page).subscribe(function (response) {
    ...
    AdminSkillCenturyCategoryComponent.prototype.delete = function (CategoryId) {
        var _this = this;
        ...
        $.confirm({
            ...
            buttons: {
                acptar: {
                    ...
                    btnClass: 'btn-green',
                    action: function () {
                        _this._skillCenturyCategoryService.delete(CategoryId).subscribe(function (response) {
    ...
    AdminSkillCenturyCategoryComponent = __decorate([
        core_1.Component({
    ...
    return AdminSkillCenturyCategoryComponent;
}(helper_1.Helper));
exports.AdminSkillCenturyCategoryComponent = AdminSkillCenturyCategoryComponent;
//# sourceMappingURL=admin-skill-century-categories.component.js.map