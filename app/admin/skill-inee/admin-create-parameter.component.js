...
var AdminCreateParameterComponent = (function () {
    function AdminCreateParameterComponent(_ineeService, _activatedRoute, _notificationsService ,location) {
    ...
    AdminCreateParameterComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        ...
        this._activatedRoute.params.subscribe(function (params) {
            ...
            _this._ineeService.getDimension(id).subscribe(function (response) {
                _this.dimension = response.dimension;
                _this.parameters = response.parameters;
                _this.loading = false;
            });
        });
    };
    AdminCreateParameterComponent.prototype.onChange = function (event) {
        if (event.length > 0) {
    ...
    AdminCreateParameterComponent.prototype.onSubmit = function () {
        var _this = this;
        //noinspection TypeScriptValidateJSTypes
        jQuery("#parameterFormButton").button('loading');
        this._ineeService.createParameter(this.model, this.dimension.id).subscribe(function (response) {
            //noinspection TypeScriptValidateJSTypes
            jQuery("#parameterFormButton").button('reset');
            if (response.status == 'success') {
                _this._notificationsService.success(response.title, response.message);
                _this.parameters.push(response.data);
            }
            else {
    ...
    AdminCreateParameterComponent.prototype.toGoBack = function () {
        var _this = this;
        _this.location.back();
    };
	AdminCreateParameterComponent.prototype.delete = function (id) {
        var _this = this;
        ...
        $.confirm({
            ...
            buttons: {
                acptar: {
                    ...
                    btnClass: 'btn-green',
                    action: function () {
						_this._ineeService.delete(id,1).subscribe(function (response) {

							if (response.status == 200) {
								_this._notificationsService.success(response.title, response.message);
								jQuery("#parameter-" + id).remove();
							}
							else {
								_this._notificationsService.error(response.title, response.message);
							}
	...
	AdminCreateParameterComponent.prototype.edit = function (id, name) {
        var _this = this;
				...
				formSubmit: {
					...
					action: function () {
						...
						if(!name){
							...
							_this._ineeService.edit(id, name,1).subscribe(function (response) {
	...
	AdminCreateParameterComponent = __decorate([
        core_1.Component({
            templateUrl: 'app/views/admin/skill-inee/dimension/add_parameter.html',
    ...
    return AdminCreateParameterComponent;
}());
exports.AdminCreateParameterComponent = AdminCreateParameterComponent;
//# sourceMappingURL=admin-create-parameter.component.js.map